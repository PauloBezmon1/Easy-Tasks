    ...
    return(
      ...
      {openTaskForm && (
        <>
          ...
          <div id="modal">Escreva a Tarefa <br />
            <input className="px-1 py-1 " type="text" value={valor} onChange={handleChange}/></div>
            <button className="px-5 py-1 bg-sky-500 hover:bg-sky-700" onClick={() => setOpenTaskForm(false)}>Criar</button>
            <button className="px-5 py-1 bg-sky-500 hover:bg-sky-700" onClick={() => setOpenTaskForm(false)}>Cancelar</button>
          </div>
        </>
      )}
      </>
